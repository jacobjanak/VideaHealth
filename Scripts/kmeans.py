"""
This script implements K-means to properly cluster the boxes into
a variable number of clusters and then does some simple algorithms to
turn the clusters into one single box.
"""
